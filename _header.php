...
<html>
<head>
	<title>Laundry Matlab | Dashboard</title>
	<link rel="stylesheet" href="<?=url('_assets/css/style.css')?>">
	<link rel="shortcut icon" href="<?=url('_assets/img/logo/unindra.png')?>" type="image/x-icon">
</head>
<body>
	...
	<header>
		<nav>
			<div class="logo">
				<a href="<?=url()?>">
					<img src="<?=url('_assets/img/logo/unindra.png')?>" alt="Laundry Matlab">
				</a>
			</div>
			<ul class="nav-menu">
				<li>
